...
analyzers = {'UnprocessedAnalyzer': 'Unprocessed data', 
             'ZScoreFilteredAnalyzer': 'Z-score filtered data', 
             'IQRFilteredAnalyzer': 'IQR filtered data',
             'SubExAnalyzer': 'Subject exclusion criteria added to remove subjects with poor quality data',
             'IQRFilteredSubExAnalyzer': 'IQR filtered data with subject exclusion criteria',}
